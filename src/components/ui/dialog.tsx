...
>(({ className, children, description, ...props }, ref) => {
  ...
  const finalDescriptionId = descriptionId || (description ? generatedDescriptionId : null);
    ...
    <DialogDescriptionContext.Provider value={{ descriptionId, setDescriptionId }}>
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          aria-describedby={finalDescriptionId || undefined}
          {...props}
        >
          {description && (
...
>(({ className, id, ...props }, ref) => {
  const { setDescriptionId } = React.useContext(DialogDescriptionContext);
